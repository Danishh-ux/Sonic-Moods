...
const Relaxed = () => {
  ...
  useEffect(() => {
    ...
    const fetchRelaxedPlaylist = async () => {
      try {
        ...
        console.error("Error fetching relaxed playlist:", error);
      } finally {
        setIsLoading(false);
      }
    };
  ...
  return (
    <div className="app-container theme-relaxed" style={{ display: 'block', paddingTop: '100px', paddingBottom: '50px' }}>
      <button className="back-btn" onClick={() => navigate('/')}>← Back to Moods</button>
      <div className="playlist-header">
        <h1>☕ Calm Frequency</h1>
        <p>Low-fidelity beats for focus and drift</p>
      </div>
